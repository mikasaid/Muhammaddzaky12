...
Pionex  Pionex — 6 grid bots, spot-futures arb bot, smart trade and DCA bots. Free for Android and iOS!
AAX  AAX — trade bitcoin futures with fees as low as 0.02% and up to 100x leverage!
Freqtrade  Freqtrade — leading opensource cryptocurrency algorithmic trading software!
Certified Cryptocurrency Exchanges
logo	id	name	ver	doc	certified	pro
aax	aax	AAX	2	API	CCXT Certified	
...
ascendex	ascendex	AscendEX	1	API		
...
btcmarkets	btcmarkets	BTC Markets	3	API		
...
ndax	ndax	NDAX	*	API		CCXT Pro
novadax	novadax	NovaDAX	1	API		
